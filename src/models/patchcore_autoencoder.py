...
class FeatureAutoencoder(nn.Module):
    ...
    def forward(self, x):
        ...
        Returns:
            torch.Tensor: Reconstructed feature maps.
        """
...
def extract_features(loader, desc):
    ...
    Args:
        loader (DataLoader): The data loader providing the images.
        desc (str): Description for the progress bar.
        
    Returns:
        tuple: (torch.Tensor of pooled features, np.ndarray of labels)
    """
...
train_features_tensor, _ = extract_features(train_loader, "Extracting Train")
test_features_tensor, test_labels_raw = extract_features(test_loader, "Extracting Test")
...
with tracker as run:
    ...
    def calculate_ssim_errors(feature_tensor):
        ...
        Args:
            feature_tensor (torch.Tensor): The extracted feature maps.
            
        Returns:
            np.ndarray: Array of SSIM error values per sample.
        """
        with torch.no_grad():
