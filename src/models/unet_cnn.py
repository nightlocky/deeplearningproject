...
with tracker:
    ...
    def extract_spatial_errors(loader):
        ...
        Returns:
            tuple: Tensors of (original_images, reconstructed_images, difference_maps, labels).
        """
    ...
    def generate_cnn_predictions(model, maps):
        ...
        Args:
            model (nn.Module): The trained ErrorCNN.
            maps (torch.Tensor): Difference maps.
    ...
    def save_sample_visualization(orig, recon, diff, true_bin, pred_bin, score, class_id, save_name):
        """
        Plots a side-by-side comparison of original, reconstructed, and diff heatmap.
        
        Args:
            orig (torch.Tensor): Original image.
            recon (torch.Tensor): Reconstructed image.
            diff (torch.Tensor): Difference map.
            true_bin (int): Ground truth binary label.
            pred_bin (int): Predicted binary label.
            score (float): Calculated anomaly score.
            class_id (int): Original dataset class identifier.
            save_name (str): The output filename.
