...
with tracker:
    ...
    def extract_features_and_maps(loader):
        ...
        Returns:
            tuple: Tensors of (latents, original_images, reconstructed_images, difference_maps, folder_ids).
        """
    ...
    def generate_mlp_predictions(model, features):
        ...
        Args:
            ...
            features (torch.Tensor): Latent feature embeddings.
    ...
    def save_sample_visualization(orig, recon, diff, true_bin, pred_bin, score, class_id, save_name):
        ...
        Args:
            orig (torch.Tensor): Original image tensor.
            recon (torch.Tensor): Reconstructed image tensor.
            diff (torch.Tensor): Difference error map.
            true_bin (int): True label.
            pred_bin (int): Predicted label.
            score (float): Probability score.
            class_id (int): Source class.
            save_name (str): Expected saved filename.
